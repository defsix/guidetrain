...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupKeyboardHeightListener() {
        ...
        rootView.viewTreeObserver.addOnGlobalLayoutListener {
            ...
            // the screen. Confirmed correct on a real device (v1.26): a
            // real keyboard measures well clear of this threshold, and a
            // closed keyboard's own small, constant gap stays under it.
